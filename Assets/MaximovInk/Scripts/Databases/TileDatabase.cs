...
namespace MaximovInk
{
    public static class TileDatabase
    {
        ...
        private static void RegisterDefaultObjects()
        {
            ...
            RegisterObject(new ObjectTile() { GetGameObject = () => Resources.Load<GameObject>("Prefabs/switch"), Name = "switch" });
            RegisterObject(new ObjectTile() { GetGameObject = () => Resources.Load<GameObject>("Prefabs/light"), Name = "light" });
            RegisterObject(new ObjectTile() { GetGameObject = () => Resources.Load<GameObject>("Prefabs/engine"), Name = "engine" });
            RegisterObject(new ObjectTile() { GetGameObject = () => Resources.Load<GameObject>("Prefabs/saddle"), Name = "saddle" });
        }
